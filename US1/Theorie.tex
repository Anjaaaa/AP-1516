...
Auch hier sendet der Ultraschallsender einen Impuls aus. Die Schallwelle bewegt sich \todo{Gibt es eigentlich ein Wort, das die Bewegung einer Welle beschreibt? \grqq sich wellen\grqq\ ist ja wohl nicht richtig.} durch das Medium. Hinter dem Medium sollte ein Material mit möglichst kleiner akustischer Impedanz sein, sodass ein Großteil der Welle reflektiert wird. Die Welle läuft zurück und wird vom Sender, der gleichzeitig Empfänger ist, detektiert. Ein Fremdkörper wird dadurch bemerkt, dass die hinlaufende Welle schon an ebendiesem reflektiert wird und somit vor der bis zum Ende gelaufenen Welle am Empfänger ankommt.
\begin{figure}[h!]
	\centering
