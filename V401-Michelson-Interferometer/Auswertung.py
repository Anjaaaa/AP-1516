...
write('build/Wellenlange_gesamt.tex', make_SI(Wellenlange_gesamt,r'\meter','e-9', figures=4))
...
write('build/Tabelle5.tex', make_table([np.abs(Druck_Luft), Impuls_Luft, unp.nominal_values(n_Luft)],[1,0,5]))

write('build/Tabelle6.tex', make_table([np.abs(Druck_CO2), Impuls_CO2, unp.nominal_values(n_CO2)],[1,0,5]))
