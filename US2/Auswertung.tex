...
\begin{align}
	h_\text{Herz} = \input{build/Hoehe.tex}
\end{align}
...
\begin{align}
	a = \frac{1}{2}c_\text{Wasser}t_\text{Herz} = \input{build/Kugel.tex} \ .
\end{align}
Damit kann das Herzvolumen bestimmt werden
\begin{align}
	\text{HZV} = \input{build/HZV.tex} \ .
\end{align}
\input{build/TMScan.tex}
