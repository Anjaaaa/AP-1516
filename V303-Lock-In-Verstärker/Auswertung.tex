...
Beim Versuchsaufbau mit der LED wird bei verschiedenen Abständen die Ausgangsspannung nach dem Tiefpass aufgenommen. Nach Abzug der Verstärkungs-Multiplikatoren (Gains) ergeben sich die Werte aus Tabelle \ref{Tabelle_Lampe}. \todo{Diesen Satz finde ich ganz grausam und unnötig, aber es steht ausdrücklich in der Anleitung, dass das erwähnt werden soll...} Zu Beginn wurde außerdem eine Nullspannung $U_0=\SI{0}{\volt}$ gemessen, weshalb keine weitere Verschiebung beachtet werden muss. 
