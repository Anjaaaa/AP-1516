...
# 1 ist immer weiter das, was weiter weg von der Heizung war
...
rho_Messing = 8520
c_Messing = 385
k_Messing = (rho_Messing*c_Messing*x**2) / (2*Delta_tM*np.log(A2M/A1M))

print('Wärmeleitfähigkeit Messing:', k_Messing)
k_M = ufloat(np.mean(k_Messing), np.std(k_Messing)/len(k_Messing))
print('Wärmeleitfähigkeit Messing:', k_M)
...
rho_Aluminium = 2800
c_Aluminium = 830
k_Aluminium = (rho_Aluminium*c_Aluminium*x**2) / (2*Delta_tA*np.log(A2A/A1A))

print('Wärmeleitfähigkeit Aluminium:', k_Aluminium)
k_A = ufloat(np.mean(k_Aluminium), np.std(k_Aluminium)/len(k_Aluminium))
print('Wärmeleitfähigkeit Aluminium:', k_A)
...
rho_Edelstahl = 8000
c_Edelstahl = 400
k_Edelstahl = (rho_Edelstahl*c_Edelstahl*x**2) / (2*Delta_tE*np.log(A2E/A1E))

print('Wärmeleitfähigkeit Edelstahl:', k_Edelstahl)
k_E = ufloat(np.mean(k_Edelstahl), np.std(k_Edelstahl)/len(k_Edelstahl))
print('Wärmeleitfähigkeit Edelstahl:', k_E)
