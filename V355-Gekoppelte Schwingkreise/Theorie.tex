...
\todo{Ich glaube hier müsste ein Minus sein und keine 2.}
 \begin{equation}
 f = 2 \pi (\nu^+ + \nu^-) \quad .
 \end{equation}
 Es handelt sich um einen periodischen Energieaustausch zwischen den beiden Schwingkreisen mit der Schwebungsfrequenz.
 \todo[color=red, inline]{Entweder ich habe einen großen Denkfrehler, oder die Anleitung ist an dieser Stelle falsch und verstauch die Frequenz mit der Winkelgeschwindigkeit?! Es geht um Formel (12) und (13) in Vergleich mit dem Fließtext oben auf Seite 302.}
 \todo[color = green, inline]{Jetzt wo du es sagst. Bei den angegebenen Frequenzen ganz oben auf 302 haben die $\nu$ und $\omega$ vertauscht. So wie du das gemacht hast ist das meine ich richtig. (Bis auf die Schwebung). Ich hoffe, das war es was du meintest.}
