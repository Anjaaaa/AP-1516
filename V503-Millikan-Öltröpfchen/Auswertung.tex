\subsection{Auswahl der Tröpfchen}
...
\begin{tabular}{cccccc|c}
	...
	\hline
	\input{build/Geschwindigkeiten.tex}
\end{tabular}
...
\begin{align}
\eta_\text{L} = \input{build/Steigung.tex}(T-\SI{273.15}{\celsius}) + \input{build/Verschiebung.tex} \ .
\end{align}
\begin{table}[h!]
	\centering
\begin{tabular}{ccccc}
...
\begin{align}
	e_0 = \input{build/Elementarladung.tex} \ .
\end{align}
\begin{figure}[h!]
	\centering
