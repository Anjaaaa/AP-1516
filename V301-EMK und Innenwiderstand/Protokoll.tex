...
\todo[inline]{Ich habe das Fehlerkapitel ganz rausgelassen, weil wir a) an keiner Stelle einen Mittelwert ausrechenen und b) die Regression bei Python ja scheinbar sowieso anders läuft.}
