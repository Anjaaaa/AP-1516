...
\usepackage{geometry}
\geometry{a4paper, top=30mm, left=30mm, right=30mm, bottom=20mm}
\usepackage{multicol}
\usepackage{color}
...
\todo[inline, color = lightgray]{Bei der Korrektur war uns einiges unklar. Fragen sind in solchen grauen Kästen im Text.}
\clearpage
