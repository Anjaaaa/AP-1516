...
Bei der Bewegung durch Gas verliert ein Alpha-Teilchen Energie durch Ionisierung, Anregung und Dissoziation (Spaltung) von anderen Teilchen oder durch elastisches Stoßen. Dieser Energieverlust hängt von der Dichte des Gases und der Energie des Teilchens. \todo[color=red]{In der Anleitung steht: Je kleiner die Geschwindigkeit, desto größer die Wahrscheinlichkeit der Wechselwirkung mit Molekülen. Warum?} Ist die Energie groß genug kann der Energieverlust mit der Bethe-Bloch-Gleichung
\begin{align}
