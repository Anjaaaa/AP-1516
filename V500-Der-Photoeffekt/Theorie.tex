...
\begin{align}\label{eq:Energie}
	E_ = \frac{1}{2}mv^2 = eU \ ,
\end{align}
mit der Elementarladung $e$, hat, kann es die Auffängerelektrode erreichen und als Strom detektiert werden. Die Spannung, bei der gerade keine Elektronen mehr die Auffängerelektrode erreichen heißt Grenzspannung $U_\text{Grenz}$ und ist ein Maß für die maximale kinetische Energie der ausgelösten Elektronen (Photoelektronen)
\begin{align}
	E_\text{max} = eU_\text{Grenz} \ .
\end{align}
