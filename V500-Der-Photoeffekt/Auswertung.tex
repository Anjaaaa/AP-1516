...
\begin{align*}
	\text{rot:} \quad & \input{build/Wellenlange_0.tex} \\
	\text{grün:} \quad & \input{build/Wellenlange_1.tex} \\
	\text{lila:} \quad & \input{build/Wellenlange_2.tex} \\
	\text{blau:} \quad & \input{build/Wellenlange_3.tex} \\
	\text{UV:} \quad & \input{build/Wellenlange_4.tex} \\
\end{align*}
...
\todo[color = red]{Diese Formel fehlt in der Theorie (das mit dem Kaptiel Messung finde ich irgendwie eigenartig), auch Abbildung 5 aus der Versuchsanleitung wäre nützlich}
\begin{align}
	I \sim U^2 \quad .
\end{align}
...
\begin{figure}[h!]
	...
	\begin{tabular}{c|ccccc}
		...
		\hline
		\input{build/tabelle_alle_wellenlangen.tex}
	\end{tabular}
...
\begin{align*}
	\text{rot:} \quad m &= \input{build/Steigung_0.tex} \\
	b &= \input{build/y-Achsenabschnitt_0.tex} \\
	U_g &= \input{build/Grenzspannung_0.tex} \\[1em]
	\text{grün:} \quad m &= \input{build/Steigung_1.tex} \\
	b &= \input{build/y-Achsenabschnitt_1.tex} \\
	U_g &= \input{build/Grenzspannung_1.tex} \\[1em]
	\text{lila:} \quad m &= \input{build/Steigung_2.tex} \\
	b &= \input{build/y-Achsenabschnitt_2.tex} \\
	U_g &= \input{build/Grenzspannung_2.tex} \\[1em]
	\text{blau:} \quad m &= \input{build/Steigung_3.tex} \\
	b &= \input{build/y-Achsenabschnitt_3.tex} \\
	U_g &= \input{build/Grenzspannung_3.tex} \\[1em]
	\text{UV:} \quad m &= \input{build/Steigung_4.tex} \\
	b &= \input{build/y-Achsenabschnitt_4.tex} \\
	U_g &= \input{build/Grenzspannung_4.tex}
\end{align*}
...
\begin{figure}[h!]
	...
	\begin{tabular}{c|c|c}
		...
		\hline
		\input{build/tabelle_h_druch_e.tex}
	\end{tabular}
	\label{tab:h_durch_e}
\end{figure}
...
\begin{align}
	& m = \frac{h}{e_0} = \input{build/h_durch_e.tex} \\
	& \Rightarrow h =  \input{build/h_durch_e_2.tex} \\
	& b = - \frac{A_k}{e_0} = \input{build/austrittsarbeit.tex} \\
	& \Rightarrow A_k = \input{build/austrittsarbeit_2.tex} 
	\end{align}
...
\todo[inline, color = red]{Alle Fragen kann ich leider nicht beantworten - irgendwie verstehe ich das dafür wohl nicht gut genug.}
